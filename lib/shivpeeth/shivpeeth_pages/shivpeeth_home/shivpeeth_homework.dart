...
class _WireframeworkState extends State<Wireframehomework> {
  ...
  Future<void> searchfilter(
    ...
    final response = await http.post(
      Uri.parse(apiUrl),
      body: {
        "class_id": clas_iddd.toString() != null
            ? clas_iddd.toString()
            : 'Select Class',
        "section_id": section_iddd.toString() != null
            ? section_iddd.toString()
            : 'Select Section',
        "branch_id": branch_id != null ? branch_id.toString() : '',
        "session_id": session_id != null ? session_id.toString() : '',
        "fromDate": fromDatedate != null
            ? DateFormat('yyyy-MM-dd').format(fromDatedate)
            : '',
      },
    );
            ...
            Column(
              children: [
                InkWell(
                  onTap: () {
                    searchfilter(
                        "Select Class", "Select Section", studenttoDate);
                  },
                  child: Image.asset(
                    WireframePngimage
            ...
            Column(
              children: [
                InkWell(
                  onTap: () {
                    searchfilter(
                        selectedValueid, selectedValuesectionid, toDate);
                  },
                  child: Image.asset(
                    WireframePngimage
                        .filter, // Replace with your image asset path
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  roletype == '7' ? studentsearch() : buildDropdownContainer(),
                  SizedBox(
                    height: 10,
                  ),
                  roletype == '3'
                  ...
                  carouselItems.length > 0
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final homeworkssearchlist item =
                                carouselItems[index];
