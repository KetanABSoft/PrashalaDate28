 ...
 void getshadpre()async {
   ...
   setState(() {
     roleid = preferences.getString('role');
        ...
        Getattendencedata(widget.classid.toString(),widget.sectionid.toString,DateTime.now());
              ...
              child: Column(
                ...
                children: [
                  ...
                  setState(() {
                    ...
                    Getattendencedata(widget.classid.toString(), widget.sectionid.toString(), selectdatedate);
                  });
                },
