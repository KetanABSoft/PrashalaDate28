                          ...
                          rows: carouselItems.map((student) {
                            return DataRow(
                              cells: [
                                ...
                                DataCell(student.present == "P" ? Icon(Icons.check) : Icon(Icons.close)),
                                DataCell(student.present == "A" ? Icon(Icons.check) : Icon(Icons.close)),
                                DataCell(student.present == "H" ? Icon(Icons.check) : Icon(Icons.close)),
                                DataCell(student.present == "L" ? Icon(Icons.check) : Icon(Icons.close)),
