...
// Mocking the file_exists function
          ...
          appBar: PreferredSize(
            ...
            child: AppBar(
              ...
              actions: [
                ...
                //     child: Icon(Icons.notifications_none_outlined, size: 35,color: Colors.black,),
                //   ),
                // ),
                Stack(
                  children: [
  ...
  Future<void> getApi() async {
    final response = await http.get(Uri.parse(
        "https://shivpeeth.com/Android_app/homeworknotification.php"));
    if (response.statusCode == 200) {
      setState(() {
        ...
        return AlertDialog(
          title: GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (context) {
                  return Wireframehomework(classid: "1", sectionid: "2");
                },
              ));
            },
